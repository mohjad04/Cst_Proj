...
//   const [breakdownTab, setBreakdownTab] = useState("status"); // status | zones | priority | category | sla
...
//   // ✅ status added to breakdowns (inside Requests)
//   const breakdownTabs = [
...
//             {/* ✅ Request Breakdowns now includes Status */}
//             <Section
//               title="Request Breakdowns"
//               subtitle="Switch between status, zones, priority, category, SLA"
...
//               {breakdownTab === "status" && (
//                 <Card title="By Status" subtitle="Requests by status">
...
//               {breakdownTab === "zones" && (
//                 <Card title="By Zone" subtitle="Geographical distribution">
...
//                 <Card title="By Priority" subtitle="Priority distribution">
...
//                 <Card title="By Category" subtitle="Categories and subcategories">
...
//           <Section
//             title="Analytics"
//             subtitle="Empty for now — you will add later"
//             right={<span style={styles.smallPill}>Coming soon</span>}
//           >
//             <div style={styles.placeholderBox}>
//               This page is intentionally empty. Add analytics charts/cards later.
//             </div>
//           </Section>
//         )}
//       </div>
...
//   },
//   pageSubtitle: { marginTop: 4, fontSize: 13, color: "#64748b" },
//   headerMeta: {
//     fontSize: 12,
//     color: "#64748b",
//     background: "#ffffff",
